...
from models.simplenet import SimpleNet3D


class Brats3dSimplenetTrainer:
    ...
    #     self.pnet = SimpleNet3D(self.config.model.c_in-3,
    ...
    def train_epoch(self):
        ...
        for image_paths, inputs, true_labels in tqdm(self.dataloaders["train"], 
            ...
            pnet_pred_labels = torch.zeros_like(true_labels)
